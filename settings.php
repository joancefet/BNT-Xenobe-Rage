...
echo "<table><tbody>";
line("","Setting", "right");
line("Shipyard Bonus Rate: Fighters ","{$facility_bonus_fighters}%", "right");
line("Shipyard Bonus Rate: Torpedoes ","{$facility_bonus_torps}%", "right");
line("Solar Plant Bonus Rate ","{$facility_bonus_energy}%", "right");
line("Hydroponics Bonus Rate ","{$facility_bonus_hydro}%", "right");
line("Bank Bonus Rate ","{$facility_bonus_bank}%", "right");
line("Homeworld Senate Bonus: Organics ","{$facility_bonus_homeworld_organics}%", "right");
line("Homeworld Senate Bonus: Ore ","{$facility_bonus_homeworld_ore}%", "right");
line("Homeworld Senate Bonus: Goods ","{$facility_bonus_homeworld_goods}%", "right");
line("Homeworld Senate Bonus: Energy ","{$facility_bonus_homeworld_energy}%", "right");
line("Homeworld Senate Bonus: Fighters ","{$facility_bonus_homeworld_fighters}%", "right");
line("Homeworld Senate Bonus: Torpedoes ","{$facility_bonus_homeworld_torps}%", "right");
