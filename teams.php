...
switch ($teamwhat)
{
    ...
    case 2: // LEAVE
    {
        ...
        elseif ($confirmleave == 1)
        {
            if ($team['number_of_members'] == 1)
            {
				...
				$log_manager->player_log($playerinfo['ship_id'],40,$team['team_name'],'','','',"<font color='#6190a5'>Low Priority</font>","<b>Team Update</b>");
            ...
            else
            {
                ...
                else
                {
					...
					$log_manager->player_log($playerinfo['ship_id'],40,$team['team_name'],'','','',"<font color='#6190a5'>Low Priority</font>","<b>Team Update</b>");
                    //playerlog ($db, $playerinfo['ship_id'], LOG_TEAM_LEAVE, $team['team_name']);
					$log_manager->player_log($team['creator'],41,$playerinfo['character_name'],'','','',"<font color='#6190a5'>Low Priority</font>","<b>Team Update</b>");
        ...
        elseif ($confirmleave == 2)
        {
			...
			$log_manager->player_log($playerinfo['ship_id'],42,$team['team_name'],$newcreatorname['character_name'],'','',"<font color='#6190a5'>Low Priority</font>","<b>Team Update</b>");
           // playerlog ($db, $playerinfo['ship_id'], LOG_TEAM_NEWLEAD, $team['team_name'] ."|". $newcreatorname['character_name']);
			$log_manager->player_log($newcreator,43,$team['team_name'],'','','',"<font color='#6190a5'>Low Priority</font>","<b>Team Update</b>");
    ...
    case 3: // JOIN
    {
        ...
        else
        {
            if ($playerinfo['team_invite'] == $whichteam)
            {
				...
				$log_manager->player_log($playerinfo['ship_id'],44,$team['team_name'],'','','',"<font color='#6190a5'>Low Priority</font>","<b>Team Update</b>");
               // playerlog ($db, $playerinfo['ship_id'], LOG_TEAM_JOIN, $team['team_name']);
				$log_manager->player_log($team['creator'],45,$team['team_name'],$playerinfo['character_name'],'','',"<font color='#6190a5'>Low Priority</font>","<b>Team Update</b>");
    ...
    case 5: // Eject member
    {
        ...
        else
        {
            ...
            else
            {
				...
				$log_manager->player_log($who,46,$team['team_name'],'','','',"<font color='#6190a5'>Low Priority</font>","<b>Team Update</b>");
    ...
    case 6: // Create Team
    {
        ...
        if (is_null($teamname))
        {
            ...
            echo "<input type='text' name='teamdesc' size='40' maxlength='125'><br>\n";
        ...
        else
        {
            ...
            {
                echo "<span style='color:#f00;'>Team Creation Failed</span><br>Sorry you have either entered an invalid Team name or Team Description. ~(Also Name limited to 40 characters, and description limited to 125 characters)<br>\n";
                LINK_BACK();
                break;
            }
			...
			$log_manager->player_log($playerinfo['ship_id'],47,$teamname,'','','',"<font color='#6190a5'>Low Priority</font>","<b>Team Update</b>");
        ...
        else
        {
            if ($playerinfo['team'] == $whichteam)
            {
                ...
                else
                {
					...
					$log_manager->player_log($who,48,$team['team_name'],'','','',"<font color='#6190a5'>Low Priority</font>","<b>Team Update</b>");
    ...
    case 8: // REFUSE invitation
    {
        ...
        db_op_result ($db, $resx, __LINE__, __FILE__, $db_logging);
		$log_manager->player_log($team['creator'],49,$playerinfo['character_name'],$invite_info['team_name'],'','',"<font color='#6190a5'>Low Priority</font>","<b>Team Update</b>");
    ...
    case 9: // Edit Team
    {
        ...
        else
        {
            ...
            {
				echo "<span style='color:#f00;'>Team Edit Failed</span><br>Sorry you have either entered an invalid Team name or Team Description. ~(Also Name limited to 40 characters, and description limited to 125 characters)<br>\n";
                LINK_BACK();
                break;
            }
			...
			$log_manager->player_log($playerinfo['ship_id'],50,$teamname,'','','',"<font color='#6190a5'>Low Priority</font>","<b>Team Update</b>");
           // playerlog ($db, $playerinfo['ship_id'], LOG_TEAM_RENAME, $teamname);
            while (!$result_team_name->EOF)
            {
                $teamname_array = $result_team_name->fields;
				$log_manager->player_log($teamname_array['ship_id'],51,$teamname,'','','',"<font color='#6190a5'>Low Priority</font>","<b>Team Update</b>");
