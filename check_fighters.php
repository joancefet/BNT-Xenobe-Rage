...
<?
            ...
            case "pay":
                ...
                else
                {
					...
					$log_manager->player_log($playerinfo['ship_id'],54,$tollstring,$sector,'','',"<font color='#E9AB17'>Medium Priority</font>","<b>Minefield Detected</b>");
...
<?
            ...
            default:
                ...
                if ($defences[0]['fm_setting'] == "toll")
                {
                    ...
                    echo "<input type='radio' name='response' value='pay'>" . $l_chf_inputpay . "<br></input>";
                }

                echo "<input type='radio' name='response' value='fight'>";
                $l_chf_inputfight = str_replace("[fight]", "<strong>Fight</strong>", $l_chf_inputfight);
                echo $l_chf_inputfight . "<br></input>";

                echo "<input type=radio name='response' value='sneak'>";
