...
else
{
	...
	*/	
	...
	echo "<td><a href=\"" . $link . "team\">KD Ratio</a></td>";
    ...
    while (!$res->EOF)
    {
        ...
        echo "<span class='table_word_gold'>$row[character_name]</span></td><td>" . NUMBER($row['turns_used']) . "</td>".$user_active_now."<td>".$the_team."&nbsp;</td><td>" . NUMBER($row['ship_kills']) . " / " . NUMBER($row['ship_deaths']) . "</td><td>$row[efficiency]</td></tr>";
