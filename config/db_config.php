...
Username + Password
*/
$ADODB_SESSION_USER = "stell530_stellar";
$ADODB_SESSION_PWD = "joan18957";
/*
Database Name
*/
$ADODB_SESSION_DB = "stell530_bnt";

// Define a random crypto key for ADOdb to use for encrypted sessions.
$ADODB_CRYPT_KEY = "kuh4324h2u4424ll";
...
$website_domain_default = "www.stellarwars.net";
