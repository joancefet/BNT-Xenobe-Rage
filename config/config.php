...
$release_version            = '0.18';                           // Please do not change this. Doing so will cause problems for the server lists, and setupinfo, and more.
...
/*PLANET*/
$facility_bonus_fighters	= 2.5;								// BONUS production due to shipyard facility
$facility_bonus_torps		= 2.5;								// BONUS production due to shipyard facility
$facility_bonus_energy		= 2.5;								// BONUS production due to solar facility
$facility_bonus_hydro		= 2.5;								// BONUS production due to hydro facility
$facility_bonus_bank		= 0.01;							// BONUS interest due to banking facility
$facility_bonus_homeworld_organics = 1;
$facility_bonus_homeworld_ore = 1;
$facility_bonus_homeworld_goods = 1;
$facility_bonus_homeworld_energy = 1;
$facility_bonus_homeworld_fighters = 1;
$facility_bonus_homeworld_torps = 1;

/*EMPIRE*/
$facility_hydroponics_food		= 1;								//hydroponics produces this empire food per tick
$facility_shipyard_parts		= 1;								//Shipyard produces this empire part per tick
...
/*POINTS*/
$global_points_ship_kills	= 1;								//Points given to player for ship kills
$global_points_planet_genesis	= 1;							//Points given/taken to player for destroying (taken) /creating (given) planets
...
$email_server               = 'joancefet@gmail.com';               // What mail server (an FQDN DNS name) should emails be sent from?
$adminpass                  = 'joan18957';                         // The administrator password
$admin_mail                 = 'joancefet@gmail.com';              // The administrator email address
$adminname                  = 'joancefet';                     // The title for the administrator (used when emailing)
$lang = $default_lang;
