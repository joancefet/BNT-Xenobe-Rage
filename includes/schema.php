...
$db->Execute("CREATE TABLE IF NOT EXISTS {$db->prefix}account (" .
			 ...
			 "personal_question_1 char(200) NOT NULL," .
			 "personal_question_1_answer char(200) NOT NULL," .
			 "personal_question_2 char(200) NOT NULL," .
			 "personal_question_2_answer char(200) NOT NULL," .
			 "personal_question_3 char(200) NOT NULL," .
			 "personal_question_3_answer char(200) NOT NULL," .
