    ...
    if (empty($command))
    {
        ...
        if ($playerinfo['ship_id'] == $planetinfo['owner'])
        {
            ...
            elseif ($destroy == 2 && $allow_genesis_destroy)
            {
                ...
                {
					/*We dont aprove of this... lets deduct a point....*/
					$sql_manager->remove_points_from_player($playerinfo['ship_id'],$global_points_planet_genesis);
        ...
        if ($planetinfo['owner'] == $playerinfo['ship_id'] || ($planetinfo['corp'] == $playerinfo['team'] && $playerinfo['team'] > 0))
        {
            ...
            {
				?>
				<div class="planet-facility-stats-table-container">
				<tbody>
				<tr>
				<td>
				<div class='planet-facility'>
					<?
					if ($planetinfo['facility_hydroponics'] == "N")
					{
					?>
						<img src="templates/alienrage/images/facility-hydro.png" />  
						<div class='planet-facility-child'>
							<a href=planet.php?planet_id=<? echo $planet_id; ?>&command=facility_hydroponics> <p>Build Hydroponics</p></a>
                            <ul>
                            <li>-Bonus:<br/><? echo $facility_bonus_hydro; ?>% Organics</li>
                            <li>-Empire: <? echo $facility_hydroponics_food; ?> Food</li>
                            </ul>
						</div>
					<?
					}
					...
					{
					?>
						<img src="templates/alienrage/images/facility-hydro-h.png" />
					<?
					}
					?>
					</div>
				...
				<div class='planet-facility'>
					...
					{
					?>
					  <img src="templates/alienrage/images/facility-bank.png" />
					  <div class='planet-facility-child'>
						<a href=planet.php?planet_id=<? echo $planet_id; ?>&command=facility_bank><p>Build Bank</p></a>
                        <ul>
                            <li>-Bonus:<br/><? echo $facility_bonus_bank; ?>% Credits</li>
                            <li>-Empire: <? echo $facility_mining_ore; ?> Rare Ores</li>
                            </ul>
					  </div>
					<?
					}
					...
					{
					?>
						<img src="templates/alienrage/images/facility-bank-h.png" />
					<?
					}
					?>
					</div>
				...
				<div class='planet-facility'>
					...
					{
					?>
					  <img src="templates/alienrage/images/facility-shipyard.png" />
					  <div class='planet-facility-child'>
						<a href=planet.php?planet_id=<? echo $planet_id; ?>&command=facility_shipyard><p>Build Shipyard</p></a>
                         <ul>
                            <li>-Bonus:<br/><? echo $facility_bonus_fighters; ?>% Fighters<br/><? echo $facility_bonus_torps; ?>% Torpedoes</li>
                            <li>-Empire: <? echo $facility_shipyard_parts; ?> Part</li>
                            </ul>
					  </div>
					<?
					}
					...
					{
					?>
						<img src="templates/alienrage/images/facility-shipyard-h.png" />
					<?
					}
					?>
					</div>
				...
				<div class='planet-facility'>
					...
					{
					?>
					  <img src="templates/alienrage/images/facility-solar.png" />
					  <div class='planet-facility-child'>
						<a href=planet.php?planet_id=<? echo $planet_id; ?>&command=facility_solarplant><p>Build Solar Plant</p></a>
						 <ul>
                            <li>-Bonus: <? echo $facility_bonus_energy; ?>% Energy</li>
                            <li>-Empire: <? echo $facility_solarplant_energy; ?> Cells</li>
                            <li>-Solar Storm Immunity</li>
                            </ul>
					  </div>
					<?
					}
					...
					{
					?>
						<img src="templates/alienrage/images/facility-solar-h.png" />
					<?
					}
					?>
					</div>
				...
				<div class='planet-facility'>
					...
					{
					?>
					  <img src="templates/alienrage/images/facility-medical.png" />
					  <div class='planet-facility-child'>
						<a href=planet.php?planet_id=<? echo $planet_id; ?>&command=facility_medical><p>Build Hospital</p></a>
                        <ul>
                            <li>-Double Population Limit</li>
                            <li>-Plague Immunity</li>
						</ul>
					  </div>
					<?
					}
					...
					{
					?>
						<img src="templates/alienrage/images/facility-medical-h.png" />
					<?
					}
					?>
					</div>
				...
				<div class='planet-facility'>
					...
					{
					?>
					  <img src="templates/alienrage/images/facility-military.png" />
					  <div class='planet-facility-child'>
						<a href=planet.php?planet_id=<? echo $planet_id; ?>&command=facility_military><p>Build Military Base</p></a>
                        <ul>
                            <li>-Nothin....</li>
						</ul>
					  </div>
					...
					{
					?>
						<img src="templates/alienrage/images/facility-military-h.png" />
					<?
					}
					?>
					</div>
				...
				<div class='planet-facility'>
					...
					{
					?>
					  <img src="templates/alienrage/images/facility-research.png" />
					  <div class='planet-facility-child'>
						<a href=planet.php?planet_id=<? echo $planet_id; ?>&command=facility_research><p>Build Research Labs</p></a>
                        <ul>
                        <li>-Empire: <? echo $facility_research_points; ?> research</li>
                        </ul>
					  </div>
					<?
					}
					...
					{
					?>
						<img src="templates/alienrage/images/facility-research-h.png" />
					<?
					}
					?>
					</div>
				...
				<div class='planet-facility'>
					...
					{
					?>
					  <img src="templates/alienrage/images/facility-homeworld.png" />
					  <div class='planet-facility-child'>
						<a href=planet.php?planet_id=<? echo $planet_id; ?>&command=facility_homeworld><p>Build Senate</p></a>
                        <ul>
                        <li>-Bonus: <br/>
                        <? echo $facility_bonus_homeworld_organics; ?>% Organics, <? echo $facility_bonus_homeworld_ore; ?>% Ore, <? echo $facility_bonus_homeworld_goods; ?>% Goods, <? echo $facility_bonus_homeworld_energy; ?>% Energy, <? echo $facility_bonus_homeworld_fighters; ?>% Fighters, <? echo $facility_bonus_homeworld_torps; ?>% Torpedoes.
					...
					{
					?>
						<img src="templates/alienrage/images/facility-homeworld-h.png" />
					<?
					}
					?>
					</div>
    ...
    else
    {
        ...
        elseif ($command == "scan")
        {
            ...
            if ($roll > $success)
            {
				...
				$log_manager->player_log($ownerinfo['ship_id'],38,$planetinfo[name],$playerinfo[sector],$playerinfo[ship_id],'',"<font color='#E9AB17'>Medium Priority</font>","<b>Planet Scanned</b>");
            ...
            {
				$log_manager->player_log($ownerinfo['ship_id'],39,$planetinfo[name],$playerinfo[sector],$playerinfo[ship_id],'',"<font color='#E9AB17'>Medium Priority</font>","<b>Planet Scanned</b>");
				/*
				REDUNDANT
                ...
                echo "Scan results of ".$planetinfo['name'].", owned by:  ".$ownerinfo['character_name']."<br/>Please be warned due to unknown interference we can only guarantee an accuracy rate of ".$sc_error."%.<br/><br/>";
				/*
				Build table
				*/	
				?>
