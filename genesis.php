...
####
##
## Due to conversion to classes system (slowly) code like that below with table locking and such needs to be in place until entire script is re-written
##
####
        ...
        if ($zoneinfo['corp_zone'] == 'N')
        {
            ...
            else
            {
                ...
                else
                {
					...
					$sql_manager->add_points_to_player($playerinfo['ship_id'],$global_points_planet_genesis);
                }
            }
        }
