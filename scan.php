...
else
{
    ...
    else
    {
        ...
        if ($roll > $success)
        {
			...
			$log_manager->player_log($targetinfo['ship_id'],55,$playerinfo['ship_id'],'','','',"<font color='#E9AB17'>Medium Priority</font>","<b>Ship Scanned</b>");
			/*Redundant*/			
        ...
        else
        {
            ...
            echo "</table><br>";
			$log_manager->player_log($targetinfo['ship_id'],56,$playerinfo['ship_id'],'','','',"<font color='#E9AB17'>Medium Priority</font>","<b>Ship Scanned</b>");
			/*REDUNDANT*/
